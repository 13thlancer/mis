                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select class="form-control"  style="width:75%;" name="type" id="type">
                                    ...
                                    <option value='21'>民事</option>
                                    <option value='22'>商业</option>
                                    <option value='23'>知识产权</option>
                                    <option value='24'>涉外商事</option>
                                    <option value='25'>房产权</option>
                                    <option value='26'>劳动争议</option>
...
//                alert(  document.getElementById("Id").value)
    ...
    function updateArticle(){
        ...
        $.ajax({
            type:"POST",
            url:"<%=basePath%>LawyerController/UpdateArticle",
            async:false,
            data:formData,
            contentType:false,
            processData:false,
