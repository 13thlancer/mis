                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select class="form-control"  style="width:75%;" name="type" id="type">
                                    ...
                                    <option value='11'>湖南风景</option>
                                    <option value='12'>特色美食</option>
                                    <option value='13'>人文分享</option>
                                </select>
                            </div>
                        </div>
                ...
                <div style="width:100%;">
                    <div style="width:60%;margin-left: auto;margin-right: auto;">
                        ...
                        <div id="return" style="height:30px;width:50px;float:left;margin-left: 10%;">
                            <button style="height:30px;width:50px;border:none;background: steelblue;color:white;" onclick="location.href='pfhumanity.jsp'">返回</button>
                        </div>
                    </div>
                </div>
            </div>
...
//                alert(  document.getElementById("Id").value)
    ...
    function updateArticle(){
        ...
        $.ajax({
            ...
            processData:false,
            success:function(data){
                window.location.href="pfhumanity.jsp";
            }
        });
    }
