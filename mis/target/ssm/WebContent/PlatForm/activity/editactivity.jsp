                ...
                <div style="width:100%;">
                    <div style="width:60%;margin-left: auto;margin-right: auto;">
                        ...
                        <div id="return" style="height:30px;width:50px;float:left;margin-left: 10%;">
                            <button style="height:30px;width:50px;border:none;background: steelblue;color:white;" onclick="location.href='pfactivity.jsp'">返回</button>
                        </div>
                    </div>
                </div>
            </div>
...
//                alert(  document.getElementById("Id").value)
    ...
    function updateArticle(){
        ...
        $.ajax({
            ...
            processData:false,
            success:function(data){
                window.location.href="pfactivity.jsp";
            }
        });
    }
