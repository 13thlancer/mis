                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select class="form-control"  style="width:75%;" name="type" id="type">
                                    ...
                                    <option value='91'>转发行业政策</option>
                                    <option value='92'>转发政府招商引资信息</option>
                                    <option value='93'>转发政府招标信息</option>
                                </select>
                            </div>
                        </div>
                ...
                <div style="width:100%;">
                    <div style="width:60%;margin-left: auto;margin-right: auto;">
                        ...
                        <div id="return" style="height:30px;width:50px;float:left;margin-left: 10%;">
                            <button style="height:30px;width:50px;border:none;background: steelblue;color:white;" onclick="location.href='pfGovernment.jsp'">返回</button>
                        </div>
                    </div>
                </div>
            </div>
...
//        alert(r[2]);
    ...
    function updateArticle(){
        ...
        $.ajax({
            ...
            processData:false,
            success:function(data){
                window.location.href="pfGovernment.jsp";
            }
        });
    }
