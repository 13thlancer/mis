                ...
                <div style="width:100%;">
                    <div style="width:60%;margin-left: auto;margin-right: auto;">
                        ...
                        <div id="return" style="height:30px;width:50px;float:left;margin-left: 10%;">
                            <button style="height:30px;width:50px;border:none;background: steelblue;color:white;" onclick="location.href='pfproduct.jsp'">返回</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    function addArticle(){
        ...
        $.ajax({
            ...
            success:function(data){
                window.location.href="pfproduct.jsp";
            }
        });
    }
