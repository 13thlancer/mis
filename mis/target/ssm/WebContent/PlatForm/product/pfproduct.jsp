                ...
                <div class="block-content collapse in">
                    <div class="span12">
                        <div id="addManager" style="height:30px;width:50px;float:right;margin-right: 5px;">
                            <button style="height:30px;width:50px;border:none;background: steelblue;color:white;" onclick="location.href='addproduct.jsp'">新增</button>
                        </div>
                        <br>
                        <br>
...
//                        {data: 'titlePicpath'},
                        ...
                        {data: 'updateTime'},
                        {
                            "render": function (data, type, row) {
                                ...
                                html += "&nbsp;&nbsp;&nbsp;"
                                html += "<button style='height:30px;width:50px;border:none;background: steelblue;color:white;' onclick=location.href='editproduct.jsp?id="+id+"'>编辑</button>"
                                html += "&nbsp;&nbsp;&nbsp;"
                                html += "<button style='height:30px;width:50px;border:none;background: steelblue;color:white;' onclick=location.href='viewproduct.jsp?id="+id+"'>查看</button>"
                                return html;
                            }
                        }
                    ],
